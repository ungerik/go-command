...
func ParsePackage(pkgDir, genFilename string, onlyFuncs ...string) (pkg *ast.Package, funcs map[*ast.FuncDecl]*ast.File, err error) {
...
func GenPackageFunctions(pkgDir, genFilename string, onlyFuncs ...string) error {
	...
	genFile := filepath.Join(pkgDir, genFilename)
	fmt.Println("Writing file", genFile)
	err = ioutil.WriteFile(genFile, b.Bytes(), 0660)
	if err != nil {
		return err
	}
